...
const StageUpload = ({ handleFileUpload }: StageUploadProps) => (
  <div className="w-full h-[calc(100vh-100px)] flex flex-col items-center justify-center overflow-hidden">
    <label 
      htmlFor="upload"
      className="flex flex-col items-center bg-white py-10 px-5 border-8 border-dashed border-teal-400 rounded-lg cursor-pointer"
    >
      <svg
      ...
      <p className="text-2xl text-gray-800 mt-4">교재의 사진을 올려주세요</p>
    </label>
    <input
      id="upload"
      type="file"
