      ...
      <StyledNavLink to="/profile">
        <IconContainer>
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 32 32" fill="none">
            <path d="M5.21725 25.1568C5.21725 25.1568 8.375 21.125 16.1667 21.125C23.9583 21.125 27.1175 25.1568 27.1175 25.1568M16.1667 2C8.34242 2 2 8.34242 2 16.1667C2 23.9909 8.34242 30.3333 16.1667 30.3333C23.9909 30.3333 30.3333 23.9909 30.3333 16.1667C30.3333 8.34242 23.9909 2 16.1667 2ZM16.1667 16.1667C17.2938 16.1667 18.3748 15.7189 19.1719 14.9219C19.9689 14.1248 20.4167 13.0438 20.4167 11.9167C20.4167 10.7895 19.9689 9.70849 19.1719 8.91146C18.3748 8.11443 17.2938 7.66667 16.1667 7.66667C15.0395 7.66667 13.9585 8.11443 13.1615 8.91146C12.3644 9.70849 11.9167 10.7895 11.9167 11.9167C11.9167 13.0438 12.3644 14.1248 13.1615 14.9219C13.9585 15.7189 15.0395 16.1667 16.1667 16.1667Z" stroke="black" stroke-opacity="0.5" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </IconContainer>
        <Text>프로필</Text>
      </StyledNavLink>
