    ...
    <div className="w-full h-screen flex flex-col max-w-[440px] mx-auto bg-gray-50 shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
      ...
      <div className="flex items-center justify-between p-4 bg-white border-b border-gray-200">
        ...
        <div className="text-center">
          <h1 className="text-lg font-semibold text-gray-800">개인정보처리방침</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="prose prose-sm max-w-none">
            <h2 className="text-lg font-bold text-gray-800 mb-4">개인정보처리방침</h2>
            
            <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제1조(목적)</h3>
                <p>
                  하루언어(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제2조(개인정보 처리의 원칙)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제3조(본 방침의 공개)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제4조(본 방침의 변경)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제5조(회원 가입을 위한 정보)</h3>
                <p>
                  회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.
                </p>
                <p>
                  <strong>필수 수집 정보:</strong> 이메일 주소, 비밀번호, 이름, 닉네임, 생년월일 및 휴대폰 번호
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제6조(본인 인증을 위한 정보)</h3>
                <p>
                  회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.
                </p>
                <p>
                  <strong>필수 수집 정보:</strong> 휴대폰 번호, 이메일 주소, 이름, 생년월일, 성별, 본인확인값(CI,DI) 및 이동통신사
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제7조(법정대리인 동의를 위한 정보)</h3>
                <p>
                  회사는 법정대리인의 동의가 필요한 경우 법정대리인의 동의를 위하여 다음과 같은 정보를 수집합니다.
                </p>
                <p>
                  <strong>필수 수집 정보:</strong> 보호자 이름, 보호자 생년월일, 보호자 성별, 보호자 휴대폰 번호 및 보호자 이동통신사 정보
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제8조(회사 서비스 제공을 위한 정보)</h3>
                <p>
                  회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다.
                </p>
                <p>
                  <strong>필수 수집 정보:</strong> 아이디, 이메일 주소, 이름, 생년월일 및 연락처
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제9조(서비스 이용 및 부정 이용 확인을 위한 정보)</h3>
                <p>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 서비스 이용기록, 쿠키, 접속지 정보 및 기기정보
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제10조(개인정보 수집 방법)</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제11조(개인정보의 이용)</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제12조(개인정보의 보유 및 이용기간)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제13조(법령에 따른 개인정보의 보유 및 이용기간)</h3>
                <p>회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.</p>
                <div className="ml-4 space-y-2">
                  <div>
                    <p><strong>전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보 및 보유기간</strong></p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <div>
                    <p><strong>통신비밀보호법에 따른 보유정보 및 보유기간</strong></p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                      <li>웹사이트 로그 기록 자료 : 3개월</li>
                    </ul>
                  </div>
                  <div>
                    <p><strong>전자금융거래법에 따른 보유정보 및 보유기간</strong></p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                      <li>전자금융거래에 관한 기록 : 5년</li>
                    </ul>
                  </div>
                  <div>
                    <p><strong>위치정보의 보호 및 이용 등에 관한 법률</strong></p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제14조(개인정보의 파기원칙)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제15조(개인정보파기절차)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제16조(개인정보파기방법)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제17조(광고성 정보의 전송 조치)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제18조(개인정보 조회 및 수집동의 철회)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제19조(개인정보 정보변경 등)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제20조(이용자의 의무)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제21조(개인정보 유출 등에 대한 조치)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제22조(개인정보 유출 등에 대한 조치의 예외)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제23조(국외 이전 개인정보의 보호)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제24조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제25조(쿠키 설치 허용 지정 방법)</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">제26조(권익침해에 대한 구제방법)</h3>
                <p>
