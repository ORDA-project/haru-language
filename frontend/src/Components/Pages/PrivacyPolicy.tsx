          ...
          <div className="prose prose-sm max-w-none">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed" style={smallTextStyle}>
              <div>
                ...
                <p>
                  하루언어(이하 '회사'라고 함)는 회사가 제공하고자 하는
              ...
              <div>
                ...
                <p>
                  ...
                  있는 경우에 한해 제3자에게 제공될 수 있습니다. 단, 법령의 규정
                  등에 의해 적법하게 강제되는 경우 회사는 수집한 이용자의
              ...
              <div>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 이메일 주소, 비밀번호, 이름,
                  닉네임, 생년월일 및 휴대폰 번호
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 휴대폰 번호, 이메일 주소,
                  이름, 생년월일, 성별, 본인확인값(CI,DI) 및 이동통신사
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 보호자 이름, 보호자 생년월일,
                  보호자 성별, 보호자 휴대폰 번호 및 보호자 이동통신사 정보
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 아이디, 이메일 주소, 이름,
                  생년월일 및 연락처
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  <strong>필수 수집 정보:</strong> 서비스 이용기록, 쿠키, 접속지
                  정보 및 기기정보
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  회사는 이용자의 개인정보에 대해 개인정보의 수집·이용 목적
              ...
              <div>
                ...
                <div className="ml-4 space-y-2">
                  ...
                  <div>
                    <p>
                      <strong>위치정보의 보호 및 이용 등에 관한 법률</strong>
                    </p>
                    <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <div>
                ...
                <p>
                  회사는 전항에도 불구하고 수신자가 수신거부의사를 표시하거나
              ...
              <div>
                ...
                <p>
                  ...
                  개인정보를 조회하거나 수정할 수 있으며 개인정보수집 동의
                  철회를 요청할 수 있습니다.
                </p>
                <p>
                  이용자 및 법정 대리인은 자신의 가입정보 수집 등에 대한 동의를
                  철회하기 위해서는 개인정보보호책임자 또는 담당자에게 서면,
                  전화 또는 전자우편주소로 연락하시면 회사는 지체 없이
                  조치하겠습니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계
                  법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지
                  않습니다.
                </p>
                <p>
                  회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를
                  포함)ㆍ처리위탁ㆍ보관(이하 "이전"이라 함)하려면 이용자의
                  동의를 받습니다. 다만, 본조 제3항 각 호의 사항 모두를
                ...
                <p>
                  회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각
                  호의 사항 모두를 이용자에게 고지합니다.
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>이전되는 개인정보 항목</li>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">
                  제24조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한
                  사항)
                </h3>
                <p>
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    Edge : 웹브라우저 우측 상단의 설정 메뉴 &gt; 쿠키 및 사이트
                    권한 &gt; 쿠키 및 사이트 데이터 관리 및 삭제
                  </li>
                  <li>
                    Chrome : 웹브라우저 우측 상단의 설정 메뉴 &gt; 개인정보 및
                    보안 &gt; 쿠키 및 기타 사이트 데이터
                  </li>
                  <li>
              ...
              <div className="border-t pt-4 mt-6">
                <h3 className="font-semibold text-gray-800 mb-2">부칙</h3>
                <p>
                  <strong>제1조</strong> 본 방침은 2025.02.01부터 시행됩니다.
                </p>
              </div>
            </div>
          </div>
